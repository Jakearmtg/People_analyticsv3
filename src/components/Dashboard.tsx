...
const GeneralView: React.FC<{ allData: Record<string, MonthlyData> }> = ({ allData }) => {
    {/* Fix: Explicitly typed the parameters of the sort function to ensure correct type inference for `sortedData`. This resolves errors where properties on `latestMonth` could not be accessed. */}
